...
parser.add_argument("--input_path", type=str, default='C:/Users/asus/Desktop/download/RoLabelImg_Transform-master/RoLabelImg_Transform-master/txt/', help="")
args = parser.parse_args()


if args.model == 'txt_to_xml':
    txt_path = args.input_path
    txt_list_path = 'C:/Users/asus/Desktop/download/RoLabelImg_Transform-master/RoLabelImg_Transform-master/{}_list.txt'.format(args.model)
